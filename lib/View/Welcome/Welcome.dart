...
import 'package:hupptest/View/Shop/ShopList.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child:Text("Shopify",style: TextStyle(color: primaryColor,fontSize: 30.0),),
            ),
            drawerMenu(),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 25.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Kampala, Uganda",style: TextStyle(fontSize: titleText,color: secondryColor),),
                  SizedBox(height: 5.0,),
                  Text("Yello",style: TextStyle(color: primaryColor,fontSize: normalText),),
                ],
              )
            ),
          ],
