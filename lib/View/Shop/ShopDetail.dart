...
class ShopDetail extends StatefulWidget{
  ...
  ShopDetail({required this.index,required this.image,required this.title});
...
class ShopDetailState extends State<ShopDetail> with SingleTickerProviderStateMixin{
      ...
      body: Column(
        children: <Widget>[
          ...
          CustomOutlineButton(
              ...
              textStyle: shopListButton().copyWith(fontSize: 16.0),
      ...
      children: <Widget>[
        Container(
          child: TabBar(
            ...
            tabs: <Widget>[
              Tab(
                child: Text(toUpper("products"),style: detailsTabTitle(),),
              ),
              Tab(
